        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="flex items-center gap-6">
              <a href="#" className="text-amber-700 hover:text-amber-900 font-medium">Dashboard</a>
              <a href="#" className="text-amber-600 hover:text-amber-900">Community</a>
              <a href="#" className="text-amber-600 hover:text-amber-900">Events</a>
              <a href="#" className="text-amber-600 hover:text-amber-900">Resources</a>
            </nav>
          </div>
        </div>
      </header>
